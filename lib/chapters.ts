...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "first-run", title: "첫 실행: 스크린샷 찍어보기" },
      { id: "what-is-playwright", title: "이해하기: Playwright란?" },
  ...
  },
  {
    ...
    emoji: "📧",
    sections: [
      { id: "google-api", title: "사전 준비: Google API 설정" },
      { id: "execute", title: "바로 실행하기" },
      { id: "expected", title: "실행 결과 확인" },
      { id: "pipeline", title: "이해하기: 자동화 파이프라인" },
  ...
  },
  {
    ...
    sections: [
      { id: "execute", title: "바로 실행하기" },
      { id: "result", title: "실행 결과 확인" },
      { id: "understand", title: "이해하기: Claude가 하는 일" },
      { id: "try-it", title: "직접 해보기" },
      { id: "tips", title: "엑셀 자동화 꿀팁" },
    ],
  },
  {
    id: 6,
    ...
    sections: [
      { id: "execute", title: "바로 실행하기" },
      { id: "result", title: "실행 결과 확인" },
      { id: "try-it", title: "내 주제로 해보기" },
      { id: "vibe-coding", title: "이해하기: 바이브코딩" },
  ...
  },
  {
    ...
    emoji: "💬",
    sections: [
      { id: "install-overview", title: "사전 준비" },
      ...
      { id: "why-cokacdir", title: "이해하기: 코깍딜이란?" },
